    ...
    (function(_React$Component) {
          ...
          value: function getLeftOffsetColumns(columns, index, columnsWidth) {
            ...
            for (var i = 0; i < index; i += 1) {
              ...
              if (column.show !== false) {
                ...
                var width =
                  columnsWidth[id] || column.width || column.minWidth || 100;
                offset += width;
              }
            }
      ...
      function ReactTableFixedColumns(props) {
        ...
        _this.getColumns = (0, _helpers.memoize)(function(
          ...
          return _this.getColumnsWithFixedFeature(
            sortedColumns,
            columnProps,
            columnsWidth
          );
      ...
      _createClass(ReactTableFixedColumns, [
        ...
        },
        {
          ...
          value: function getColumnsWithFixedFeature(
            columns,
            columnProps,
            columnsWidth,
            parentIsfixed,
            ...
            return columns.map(function(column, index) {
              ...
              var left =
                columnIsLeftFixed &&
                ReactTableFixedColumns.getLeftOffsetColumns(
                  columns,
                  index,
                  columnsWidth
                );
              var right =
                columnIsRightFixed &&
                ReactTableFixedColumns.getRightOffsetColumns(
                  columns,
                  index,
                  columnsWidth
                );
              ...
              if (column.columns) {
                output.columns = _this2.getColumnsWithFixedFeature(
                  column.columns,
                  columnProps,
                  columnsWidth,
                  fixed,
