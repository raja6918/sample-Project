...
const plotLabel = PANE_LABELS.FLIGHT;
const defaultRenderer = 'empty';

class FlightPane extends Component {
  state = {
    isFilterOpen: false,
    minimized: false,
    selectedPairing: {},
...
FlightPane.defaultProps = {
  ruleset: null,
  readOnly: null,
  currentCrewGroupId: null,
};

export default connect(mapStateToProps)(FlightPane);
