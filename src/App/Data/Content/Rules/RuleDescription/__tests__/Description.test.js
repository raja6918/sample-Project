...
import { ruleDescriptionData } from '../../mockData';
...
describe('Test Rule Description Component', () => {
  ...
  test.skip('Description Component renders HyperLink correctly', () => {
    ...
    wrapper.find('Description__HyperLink').prop('onClick')(
      data,
      ruleDescriptionData[0].ruleset
    );
    expect(minProps.handleLink).toBeCalledWith(
      data,
      ruleDescriptionData[0].ruleset
    );
  });
